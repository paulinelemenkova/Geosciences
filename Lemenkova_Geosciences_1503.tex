...
In such a way, this research presents a compilation of the visualized climate and environmental data based on the TerraClimate open source repository. The data show measurements of the meteorological and climate global data in the NetCDF format. The methodology applied the compiled data observations over Mongolia and visualized experimental meteorological data using GMT \cite{Wesseletal2019}. 
