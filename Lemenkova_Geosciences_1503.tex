...
To this end, the study has the following aims:     

\begin{itemize}
	\item to perform data capture, collecting, formatting, storage and processing (environmental and climate data, GEBCO and descriptive data sources);
	\item to test, evaluate and implement script-based technical methods of geospatial data analysis by GMT;
	\item	to estimate the utilisation of the script-based data processing in cartography for spatial data processing for semi-automatic mapping of raster data using various GMT modules;
	...
	\item to analyse climate and environmental setting in Mongolia using both presented maps and data available from literature sources.
\end{itemize}
