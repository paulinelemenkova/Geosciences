...
\Author{\hl{Polina Lemenkova} \orcidA{}}%MDPI: Please carefully check the accuracy of names and affiliations.
...
\subsubsection{Data}
The study is based on the integration of the open source high-resolution geospatial data. These were obtained from the TerraClimate and GEBCO as crucial sources of information in climate and environmental domains. The materials used in this study include open source data. Specifically, the data include two data sources: (1) TerraClimate, a publicly available global climate dataset in a raster NetCDF format (\href{https://climate.northwestknowledge.net/TERRACLIMATE/index_directDownloads.php}{\hl{TerraClimate}}), %MDPI: superlink is not allowed for normal words. It is suggested to put the website in bracket after the words.
 originally developed by~\cite{Abatzoglou} and updated on a regular basis; (2) GEBCO, processed for topographic mapping of Mongolia, \href{https://www.gebco.net/data_and_products/gridded_bathymetry_data/}{\hl{GEBCO}}. The TerraClimate dataset can be used for other periods since 1958 up to now aimed both at retrospective mapping and for estimating mapping proposing prognosis of future scenarios in climate change. Visualisation of such data enables to highlight changes in continuous fields based on the analysis of correlation between the isolines and correspondence of the extremal values. 
...
{The preliminary processing included initial seps that can be summarised as followed. Data were captured and collected from the available web sources (these included environmental and climate data, GEBCO and descriptive data sources), stored and formatted in a working project directory and processed by GMT, as described below.} The topographic mapping (Figure~\ref{fig1}) was based on the General Bathymetric Chart of the Oceans (GEBCO) grid~\cite{Schenke2016}, which aggregates the SRTM data for the terrestrial areas at 15 arc-second (ca. \mbox{450 m}) resolution. Other maps (Figures~\ref{fig2}--\ref{fig11}) were plotted using TerraClimate raster climate datasets. 
...
Monthly precipitation in Mongolia in 2019 (Figure~\ref{fig10}) was identified as at high levels in central regions with a general data range from minimum~=~0.0 to a maximum of 28.0 mm, a mean at 3.182 mm, and a standard deviation (StdDev) at 2.744 mm. 

The map was visualised using ‘saga-22’ cpt adopted from the SAGA open source GIS. Finally, the Palmer Drought Severity Index (PDSI) in Mongolia calculated and visualised for 2019 shows the following data range: general data range from $-$7 to +5 from very dry levels to the extreme wet values showing very dry values in the Gobi Desert while more wet and moist regions in the mountain ranges of the Altai and forests. 
...
\funding{\hl{text.}}%MDPI: Please add: ``This research received no external funding'' or ``This research was funded by NAME OF FUNDER grant number XXX.'' and and ``The APC was funded by XXX''. Check carefully that the details given are accurate and use the standard spelling of funding agency names at \url{https://search.crossref.org/funding}, any errors may affect your future funding.

\institutionalreview{\hl{text.}}%MDPI: In this section, you should add the Institutional Review Board Statement and approval number, if relevant to your study. You might choose to exclude this statement if the study did not require ethical approval. Please note that the Editorial Office might ask you for further information. Please add “The study was conducted in accordance with the Declaration of Helsinki, and approved by the Institutional Review Board (or Ethics Committee) of NAME OF INSTITUTE (protocol code XXX and date of approval).” for studies involving humans. OR “The animal study protocol was approved by the Institutional Review Board (or Ethics Committee) of NAME OF INSTITUTE (protocol code XXX and date of approval).” for studies involving animals. OR “Ethical review and approval were waived for this study due to REASON (please provide a detailed justification).” OR “Not applicable” for studies not involving humans or animals.

\informedconsent{\hl{text.}}%MDPI: Any research article describing a study involving humans should contain this statement. Please add ``Informed consent was obtained from all subjects involved in the study.'' OR ``Patient consent was waived due to REASON (please provide a detailed justification).'' OR ``Not applicable'' for studies not involving humans. You might also choose to exclude this statement if the study did not involve humans. Written informed consent for publication must be obtained from participating patients who can be identified (including by the patients themselves). Please state ``Written informed consent has been obtained from the patient(s) to publish this paper'' if applicable.

\dataavailability{The GMT codes are available on \href{https://github.com/paulinelemenkova/Mapping_Mongolia_GMT}{\hl{GitHub}}.}%MDPI: In this section, please provide details regarding where data supporting reported results can be found, including links to publicly archived datasets analyzed or generated during the study. Please refer to suggested Data Availability Statements in section ``MDPI Research Data Policies'' at \url{https://www.mdpi.com/ethics}. If the study did not report any data, you might add ``Not applicable'' here.
...
\subsection[\appendixname~\thesubsection]{GMT Script for Topographic Map, \hl{Figure}~\ref{fig1}}\label{app1}%MDPI: figure citation is not allowed in section title. Please revise it.
...
\subsection[\appendixname~\thesubsection]{\textls[-15]{GMT Script for Map in \hl{Figure}~\ref{fig2}: Average Minimal Temperature in Mongolia in 2019}}\label{app2}

Purpose: Climate datasets \href{https://climate.northwestknowledge.net/TERRACLIMATE/index_directDownloads.php}{\hl{TerraClimate}} (here: Mongolia).\setcounter{listing}{2}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig3}: Average Maximal Temperature in Mongolia in 04.2019}\label{app3}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig4}: Wind Speed in Mongolia in 2019}\label{app4}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig5}: Soil Moisture in Mongolia in 2019}\label{app5}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig6}: Downward Surface Shortwave Radiation in Mongolia in 2019}\label{app6}
...
\newpage
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig7}: Snow Water Equivalent in Mongolia in 2019}\label{app7}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig8}: Vapor Pressure Deficit in Mongolia in 2019}\label{app8}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig9}: Vapor Pressure Anomaly in Mongolia in 2019}\label{app9}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig10}: Monthly Precipitation in Mongolia in 2019}\label{app10}
...
\subsection[\appendixname~\thesubsection]{GMT Script for Map in \hl{Figure}~\ref{fig11}: Palmer Drought Severity Index (PDSI) in Mongolia in 2019}\label{app11}
...
\newblock {\em Environ. Res.} {\bf 2016}, {\em 144},~96--112, https://doi.org/10.1016/j.envres.2015.09.020.%MDPI: Duplicate references are not allowed. Reference [20] is the same as [79], please check and revise.
...
\newblock  Performance assessment of merged multisatellite
  ...
  Precipitation Science}; Michaelides, S., Ed.; Elsevier:  \hl{Amsterdam, The Netherlands,} %newly added information, please confirm
...
\newblock In Proceedings of the 2011 International Conference on Remote
  Sensing, Environment and Transportation Engineering, \hl{Nanjing, China, 1--3 June 2012;} %Newly added information, please confirm.
...
\newblock In Proceedings of the 2018 IEEE 14th International Conference on
  e-Science (e-Science), \hl{Amsterdam, The Netherlands,  29 October--1 November 2018}; pp.~362--363, https://doi.org/10.1109/eScience.2018.00099.
...
\newblock In Proceedings of the Oceans '04 MTS/IEEE Techno-Ocean '04 (IEEE Cat.
  No. 04CH37600), \hl{Kobe, Japan, 9--12 November 2004}; Volume~2, pp.~1159--1162, https://doi.org/10.1109/OCEANS.2004.1405673.



\bibitem[Fan \em{et~al.}(2016)Fan, Chen, and John]{FAN201696}
\hl{Fan, P.;} Chen, J.; John, R.
\newblock Urbanization and environmental change during the economic transition
  on the Mongolian Plateau: Hohhot and Ulaanbaatar.
\newblock {\em Environ. Res.} {\bf 2016}, {\em 144},~96--112,
  https://doi.org/{\changeurlcolor{black}\href{https://doi.org/10.1016/j.envres.2015.09.020}{\detokenize{10.1016/j.envres.2015.09.020}}}.
...
\newblock In Proceedings of the 2009 Third International Symposium on
  Intelligent Information Technology Application, \hl{Nan Chang, China,  21--22 November 2009}; Volume~2, pp.~129--133, https://doi.org/10.1109/IITA.2009.313.
...
\newblock NOAA National Climatic Data Center: \hl{Asheville, NC, USA},  1965.


\bibitem[Group(2020)]{GEBCO}
GEBCO Compilation Group
\newblock \emph{GEBCO 2020 Grid}; \hl{GEBCO Compilation Group}: 
\newblock   2020.%MDPI: please add publisher location.
...
\newblock In Proceedings of the 2018 OCEANS---MTS/IEEE Kobe Techno-Oceans
  (OTO), \hl{Kobe, Japan,  28--31 May 2018}; pp.~1--4, https://doi.org/10.1109/OCEANSKOBE.2018.8559448.
...
\newblock In Proceedings of the 2010 IEEE International Geoscience and Remote
  Sensing Symposium, \hl{Honolulu, HI, USA,  25--30 July 2010}; pp.~1513--1516, https://doi.org/10.1109/IGARSS.2010.5652806.
...
\newblock In Proceedings of the IGARSS 2019---2019 IEEE International
  Geoscience and Remote Sensing Symposium,  \hl{Yokohama, Japan, 28 July--2 August  2019}; pp.~6479--6482, https://doi.org/10.1109/IGARSS.2019.8898380.
